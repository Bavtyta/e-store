...
export function OffersPage() {
  return (
    <InformationPage
      ...
      description="Актуальные предложения BELT для розничных и оптовых заказов без неподтверждённых скидок и скрытых условий."
      eyebrow="Предложения BELT"
      items={[
        {
          title: 'Индивидуальные условия для оптовых заказов',
          text: 'Стоимость и условия рассчитываются по составу, количеству и особенностям заказа после обращения к менеджеру.',
        },
        {
          title: 'Помощь с подбором материалов',
          text: 'Если в каталоге нет нужного исполнения, укажите материал, размеры и условия применения в форме подбора.',
        },
      ]}
